...
<html lang="en">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <div class="mail_section">
                         <h1 style="color: #080c50; font-weight: bold;">Login Page</h1>
                               <br><br>
  ...
  <form class="form-signin" action="loginServlet" method="post">
            ...
            %>
              ...
              <hr class="my-4">
              <button class="btn btn-lg btn-google btn-block text-uppercase" class="text-success" type="submit"><i class="fab fa-google mr-2"></i> <a href="reg.jsp">New User Registration</button>
